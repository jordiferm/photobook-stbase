...
namespace Digikam
{
	...
	class ST_DIGIKAM_EXPORT ThumbnailLoadThread : public ManagedLoadSaveThread
	{
		Q_OBJECT

		static ThumbnailLoadThread* defaultIconViewObject;
		static ThumbnailLoadThread* defaultObject;
		static ThumbnailLoadThread* defaultThumbBarObject;
