...
class ST_DIGIKAM_EXPORT LoadingCacheFileWatch
{
public:
...
class ST_DIGIKAM_EXPORT ClassicLoadingCacheFileWatch : public QObject, public LoadingCacheFileWatch
{
    Q_OBJECT
...
class ST_DIGIKAM_EXPORT LoadingCache : public QObject
{
    Q_OBJECT
...
public:
    ...
    class ST_DIGIKAM_EXPORT CacheLock
    {
    public:
