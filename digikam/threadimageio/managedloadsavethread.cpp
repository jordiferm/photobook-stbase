...
void ManagedLoadSaveThread::load(LoadingDescription description, LoadingMode loadingMode, LoadingPolicy policy, AccessMode accessMode)
{
    ...
    qDebug() << "ManagedLoadSaveThread::load " << description.filePath << ", policy " << policy << endl;
    switch(policy)
    {
        case LoadingPolicyFirstRemovePrevious:
            ...
            qDebug() << "LoadingPolicyFirstRemovePrevious, Existing task " << existingTask <<
            ...
            for (int i=0; i < m_todo.size(); i++)
            {
                ...
                {
                    qDebug() << "Removing task " << task << " from list" << endl;
        ...
        case LoadingPolicyPrepend:
            ...
            qDebug() << "LoadingPolicyPrepend, Existing task " << existingTask << ", m_currentTask " << m_currentTask << endl;
        ...
        case LoadingPolicyAppend:
            ...
            if (existingTask)
                break;
            qDebug() << "LoadingPolicyAppend, Existing task " << existingTask << ", m_currentTask " << m_currentTask << endl;
        ...
        case LoadingPolicyPreload:
            ...
            qDebug() << "LoadingPolicyPreload, Existing task " << existingTask << endl;
            if (existingTask)
                break;
