...
namespace DigikamImagesPluginCore
{
			...
			: EditorTool(parent)
	{
		...
		setToolName(tr("Auto Correction"));
		...
		m_previewWidget = new ImageWidget("autocorrection Tool", 0,
		                                  tr("Here you can see the auto-color correction tool "
		...
		m_thumbnailImage = iface.getOriginalImg()->smoothScale(128, 128, Qt::KeepAspectRatio);
		...
		QListWidgetItem *item = new QListWidgetItem(QIcon(pix), tr("Auto Levels"));
		item->setWhatsThis(tr("<b>Auto Levels</b>:"
		...
		item = new QListWidgetItem(QIcon(pix), tr("Normalize"));
		item->setWhatsThis(tr("<b>Normalize</b>:"
		...
		item = new QListWidgetItem(QIcon(pix), tr("Equalize"));
		item->setWhatsThis(tr("<b>Equalize</b>:"
		...
		item = new QListWidgetItem(QIcon(pix), tr("Stretch Contrast"));
		item->setWhatsThis(tr("<b>Stretch Contrast</b>:"
		...
		item = new QListWidgetItem(QIcon(pix), tr("Auto Exposure"));
		item->setWhatsThis(tr("<b>Auto Exposure</b>:"
		                      "<p>This option enhances the contrast and brightness "
		...
		if (data)
		{
			...
			switch (type)
			{
				...
				case StretchContrastCorrection:
					name = tr("Stretch Contrast");
					break;

				case AutoExposureCorrection:
					name = tr("Auto Exposure");
					break;
			}
