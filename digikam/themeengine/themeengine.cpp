...
ThemeEngineCreator* ThemeEngine::creator = 0;

ThemeEngine* ThemeEngine::instance()
{
	if (!creator)
		creator = new ThemeEngineCreator;
           ...
           : d(new ThemeEnginePriv)
{
    ...
    d->defaultTheme = new Theme(tr("Default"), QString());
    d->themeHash.insert(tr("Default"), d->defaultTheme);
