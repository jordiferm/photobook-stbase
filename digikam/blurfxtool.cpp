          ...
          : EditorToolThreaded(parent)
{
    ...
    m_effectType->addItem(tr("Zoom Blur"));
    m_effectType->addItem(tr("Radial Blur"));
    m_effectType->addItem(tr("Far Blur"));
    m_effectType->addItem(tr("Motion Blur"));
    m_effectType->addItem(tr("Softener Blur"));
    m_effectType->addItem(tr("Skake Blur"));
    m_effectType->addItem(tr("Focus Blur"));
    m_effectType->addItem(tr("Smart Blur"));
    m_effectType->addItem(tr("Frost Glass"));
    m_effectType->addItem(tr("Mosaic"));
    m_effectType->setDefaultIndex(BlurFX::ZoomBlur);
    m_effectType->setWhatsThis( tr("<p>Select the blurring effect to apply to image.</p>"
    ...
    m_distanceLabel = new QLabel(tr("Distance:"), m_gboxSettings->plainPage());
    ...
    m_distanceInput->setWhatsThis( tr("Set here the blur distance in pixels."));

    m_levelLabel = new QLabel(tr("level to use for the effect", "Level:"), m_gboxSettings->plainPage());
    ...
    m_levelInput->setWhatsThis( tr("This value controls the level to use with the current effect."));
...
{
    ImageIface iface(0, 0);
    iface.putOriginalImage(tr("Blur Effects"), filter()->getTargetImage().bits());
}
