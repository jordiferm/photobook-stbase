       ...
       : EditorTool(parent)
{
    ...
    QLabel *labelCyan = new QLabel(tr("Cyan"), m_gboxSettings->plainPage());
    ...
    m_rSlider->setWhatsThis(tr("Set here the cyan/red color adjustment of the image."));

    QLabel *labelRed = new QLabel(tr("Red"), m_gboxSettings->plainPage());
    ...
    QLabel *labelMagenta = new QLabel(tr("Magenta"), m_gboxSettings->plainPage());
    ...
    m_gSlider->setWhatsThis(tr("Set here the magenta/green color adjustment of the image."));

    QLabel *labelGreen = new QLabel(tr("Green"), m_gboxSettings->plainPage());
    ...
    QLabel *labelYellow = new QLabel(tr("Yellow"), m_gboxSettings->plainPage());
    ...
    m_bSlider->setWhatsThis(tr("Set here the yellow/blue color adjustment of the image."));

    QLabel *labelBlue = new QLabel(tr("Blue"), m_gboxSettings->plainPage());
...
void RGBTool::finalRendering()
{
    ...
    iface->putOriginalImage(tr("Color Balance"), original.bits());
    qApp->restoreOverrideCursor();
}
