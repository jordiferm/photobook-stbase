...
class ST_DIGIKAM_EXPORT PhotoInfoContainer
{
...
ST_DIGIKAM_EXPORT QDataStream& operator<<(QDataStream& ds, const PhotoInfoContainer& info);
ST_DIGIKAM_EXPORT QDataStream& operator>>(QDataStream& ds, PhotoInfoContainer& info);
