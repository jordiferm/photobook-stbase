...
namespace Digikam
{
	...
	class ST_DIGIKAM_EXPORT EditorToolIface : public QObject
	{
		Q_OBJECT
	...
	public:
		...
		EditorToolIface(QObject* _Parent);
		~EditorToolIface();
	...
	signals:
		void toolStartProgress(const QString& _ToolName);
		void toolProgress(int _Progress);
		void toolStopProgress();
	};
