       ...
       : EditorTool(parent)
{
    ...
    setToolName(tr("Brightness / Contrast / Gamma"));
    ...
    QLabel *label2 = new QLabel(tr("Brightness:"), m_gboxSettings->plainPage());
    ...
    m_bInput->setWhatsThis( tr("Set here the brightness adjustment of the image."));

    QLabel *label3 = new QLabel(tr("Contrast:"), m_gboxSettings->plainPage());
    ...
    QLabel *label4 = new QLabel(tr("Gamma:"), m_gboxSettings->plainPage());
    ...
    m_gInput->setWhatsThis( tr("Set here the gamma adjustment of the image."));
