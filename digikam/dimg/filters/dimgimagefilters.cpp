...
void DImgImageFilters::equalizeImage(uchar *data, int w, int h, bool sixteenBit)
{
    if (!data || !w || !h)
    {
       qWarning() << ("DImgImageFilters::equalizeImage: no image data available!") << endl;
       return;
    }
    ...
    if( !histogram || !map || !equalize_map )
    {
       ...
       qWarning() << ("DImgImageFilters::equalizeImage: Unable to allocate memory!") << endl;
       return;
    }
...
void DImgImageFilters::stretchContrastImage(uchar *data, int w, int h, bool sixteenBit)
{
    if (!data || !w || !h)
    {
       qWarning() << ("DImgImageFilters::stretchContrastImage: no image data available!") << endl;
       return;
    }
    ...
    if( !histogram || !normalize_map )
    {
       ...
       qWarning() << ("DImgImageFilters::stretchContrastImage: Unable to allocate memory!") << endl;
       return;
    }
...
void DImgImageFilters::autoLevelsCorrectionImage(uchar *data, int w, int h, bool sixteenBit)
{
    if (!data || !w || !h)
    {
       qWarning() << ("DImgImageFilters::autoLevelsCorrectionImage: no image data available!") << endl;
       return;
    }
    uchar* desData;
...
void DImgImageFilters::invertImage(uchar *data, int w, int h, bool sixteenBit)
{
    if (!data || !w || !h)
    {
       qWarning() << ("DImgImageFilters::invertImage: no image data available!") << endl;
       return;
    }
                                         ...
                                         float brGain, float bgGain, float bbGain)
{
    ...
    {
       qWarning() << ("DImgImageFilters::channelMixerImage: no image data available!") << endl;
       return;
    }
                                      ...
                                      int redMask, int greenMask, int blueMask)
{
    if (!data || !width || !height)
    {
       qWarning() << ("DImgImageFilters::changeTonality: no image data available!") << endl;
       return;
    }
...
void DImgImageFilters::gaussianBlurImage(uchar *data, int width, int height, bool sixteenBit, int radius)
{
    if (!data || !width || !height)
    {
       qWarning() << ("DImgImageFilters::gaussianBlurImage: no image data available!") << endl;
       return;
    }
...
void DImgImageFilters::sharpenImage(uchar *data, int width, int height, bool sixteenBit, int radius)
{
    if (!data || !width || !height)
    {
       qWarning() << ("DImgImageFilters::sharpenImage: no image data available!") << endl;
       return;
    }
