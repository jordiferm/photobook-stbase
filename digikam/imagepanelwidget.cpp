...
namespace Digikam
{
			...
			: QWidget(parent), d(new ImagePanelWidgetPriv)
	{
		...
		d->imageRegionWidget->setWhatsThis(tr("<p>Here you can see the original clip image "
		        ...
		        separateViewMode == SeparateViewAll)
		{
			...
			duplicateHorButton->setIcon(QPixmap(":/digikam/duplicatebothhorz.png"));
			duplicateHorButton->setCheckable(true);
			duplicateHorButton->setWhatsThis(tr("If you enable this option, you will separate the preview area "
			...
			duplicateVerButton->setIcon(QPixmap(":/digikam/duplicatebothvert.png"));
			duplicateVerButton->setCheckable(true);
			duplicateVerButton->setWhatsThis(tr("If you enable this option, you will separate the preview area "
		        ...
		        separateViewMode == SeparateViewAll)
		{
			...
			separateHorButton->setIcon(QPixmap(":/digikam/bothhorz.png"));
			separateHorButton->setCheckable(true);
			separateHorButton->setWhatsThis(tr("If you enable this option, you will separate the preview area "
			                                   "horizontally, displaying the original and target image "
			...
			separateVerButton->setIcon(QPixmap(":/digikam/bothvert.png"));
			separateVerButton->setCheckable(true);
			separateVerButton->setWhatsThis(tr("If you enable this option, you will separate the preview area "
			                                   "vertically, displaying the original and target image "
		...
		noSeparateButton->setIcon(QPixmap(":/digikam/target.png"));
		noSeparateButton->setCheckable(true);
		noSeparateButton->setWhatsThis(tr("If you enable this option, the preview area will not "
		                                  "be separated."));
	...
	void ImagePanelWidget::readSettings()
	{
		...
		int mode                  = (int)ImageRegionWidget::SeparateViewDuplicateVert;
	...
	{
		//TODO: Write settings with QSettings.
	...
	{
		d->imagePanIconWidget->setToolTip(tr("<nobr>(%1,%2)(%3x%4)</nobr>").arg(rect.left()).arg(	
														rect.top()).arg(rect.width()).arg(rect.height()));
	}
