       ...
       : EditorTool(parent)
{
    ...
    setToolName(tr("Hue / Saturation / Lightness"));
    ...
    m_HSSelector->setWhatsThis(tr("Select the hue and saturation adjustments of the image."));
    m_HSSelector->setMinimumSize(256, 142);

    m_HSPreview = new HSPreviewWidget(m_gboxSettings->plainPage(), m_gboxSettings->spacingHint());
    m_HSPreview->setWhatsThis(tr("You can see here a color preview of the hue and "
                                   "saturation adjustments."));
    m_HSPreview->setMinimumSize(256, 15);

    QLabel *label2 = new QLabel(tr("Hue:"), m_gboxSettings->plainPage());
    ...
    m_hInput->setWhatsThis(tr("Set here the hue adjustment of the image."));

    QLabel *label3 = new QLabel(tr("Saturation:"), m_gboxSettings->plainPage());
    ...
    m_sInput->setWhatsThis(tr("Set here the saturation adjustment of the image."));

    QLabel *label4 = new QLabel(tr("Lightness:"), m_gboxSettings->plainPage());
    ...
    m_lInput->setWhatsThis(tr("Set here the lightness adjustment of the image."));
...
void HSLTool::finalRendering()
{
    ...
    iface->putOriginalImage(tr("HSL Adjustments"), original.bits());
    qApp->restoreOverrideCursor();
}
