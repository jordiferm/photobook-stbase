...
namespace DigikamDistortionFXImagesPlugin
{
			...
			: EditorToolThreaded(parent)
	{
		...
		m_effectType->addItem(tr("Fish Eyes"));
		m_effectType->addItem(tr("Twirl"));
		m_effectType->addItem(tr("Cylindrical Hor."));
		m_effectType->addItem(tr("Cylindrical Vert."));
		m_effectType->addItem(tr("Cylindrical H/V."));
		m_effectType->addItem(tr("Caricature"));
		m_effectType->addItem(tr("Multiple Corners"));
		m_effectType->addItem(tr("Waves Hor."));
		m_effectType->addItem(tr("Waves Vert."));
		m_effectType->addItem(tr("Block Waves 1"));
		m_effectType->addItem(tr("Block Waves 2"));
		m_effectType->addItem(tr("Circular Waves 1"));
		m_effectType->addItem(tr("Circular Waves 2"));
		m_effectType->addItem(tr("Polar Coordinates"));
		m_effectType->addItem(tr("Unpolar Coordinates"));
		m_effectType->addItem(tr("Tile"));
		m_effectType->setDefaultIndex(DistortionFX::FishEye);
		m_effectType->setWhatsThis(tr("<p>Here, select the type of effect to apply to an image.</p>"
		...
		m_levelLabel = new QLabel(tr("Level:"), m_gboxSettings->plainPage());
		...
		m_iterationInput->setWhatsThis(tr("This value controls the iterations to use for Waves, "
	...
	void DistortionFXTool::putFinalData(void)
	{
		...
		iface.putOriginalImage(tr("Distortion Effects"),
