...
/**
Classe generadora de icones del gui. Consta d'un m�tode per a instalar una nova generadora d'icones per defecte: setDefaultFactory que ens permetr� canviar qualsevol icona que utilitzi el GUI de flam.
La idea no �s un estil din�mic sin� la d'un estil per a l'usuari de la llibreria.
@author Shadow
*/
