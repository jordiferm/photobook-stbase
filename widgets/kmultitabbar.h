 ...
 */
class ST_WIDGETS_EXPORT KMultiTabBar: public QWidget
{
    Q_OBJECT
public:
 ...
 */
class ST_WIDGETS_EXPORT KMultiTabBarButton: public QPushButton
{
    Q_OBJECT
public:
    int id() const;
 ...
 */
class ST_WIDGETS_EXPORT  KMultiTabBarTab: public KMultiTabBarButton
{
    Q_OBJECT
public:
