...
class ST_WIDGETS_EXPORT QfNavBarItem : public QfSelectableWidget {
	Q_OBJECT
	...
	public:
		QfNavBarItem (QWidget *parent = 0, bool _Selectable = true);
		QfNavBarItem (const QString& text, QWidget *parent = 0, bool _Selectable = true);
		QfNavBarItem (const QPixmap& icon, const QString& text, QWidget *parent = 0, bool _Selectable = true);
		~QfNavBarItem();
