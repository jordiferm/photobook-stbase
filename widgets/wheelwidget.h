...
class ST_WIDGETS_EXPORT AbstractWheelWidget : public QWidget {
    Q_OBJECT
...
class ST_WIDGETS_EXPORT StringWheelWidget : public AbstractWheelWidget {
    Q_OBJECT

public:
	StringWheelWidget(bool touch, QWidget* _Parent = 0);
