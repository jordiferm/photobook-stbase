...
//		ToolTipPalette.setColor(QPalette::Background, Qt::white);
//		ToolTipPalette.setColor(QPalette::Base, Qt::white);
//		ToolTipPalette.setColor(QPalette::ToolTipBase, Qt::white);
//		ToolTipPalette.setColor(QPalette::ToolTipText, Qt::white);
//		ToolTipPalette.setColor(QPalette::Text, Qt::white);
//		mTipLabel->setPalette(ToolTipPalette);
...
// 			textList << text;
	...
	void updateToggleSelectionButton() {
		mToggleSelectionButton->setIcon(QIcon(
			mView->selectionModel()->isSelected(mIndexUnderCursor) ? ":/st/edit_remove.png" : ":/st/edit_add.png"
			));
	}
...
PreviewItemDelegate::PreviewItemDelegate(STThumbnailView* view)
...
/*#ifndef GWENVIEW_SEMANTICINFO_BACKEND_NONE
	...
	d->mToggleSelectionButton = d->createContextBarButton(":/st/edit_add.png");
	connect(d->mToggleSelectionButton, SIGNAL(clicked()),
		SLOT(slotToggleSelectionClicked()));

	d->mFullScreenButton = d->createContextBarButton(":/st/edit_picture.png");
	connect(d->mFullScreenButton, SIGNAL(clicked()),
		SLOT(slotFullScreenClicked()) );

	d->mRotateLeftButton = d->createContextBarButton(":/st/rotateleft.png");
	connect(d->mRotateLeftButton, SIGNAL(clicked()),
		SLOT(slotRotateLeftClicked()) );

	d->mRotateRightButton = d->createContextBarButton(":/st/rotateright.png");
...
void PreviewItemDelegate::slotRotateRightClicked() {
	d->selectIndexUnderCursorIfNoMultiSelection();
	rotateDocumentRightRequested(d->mIndexUnderCursor);
}
...
void PreviewItemDelegate::slotFullScreenClicked() 
{
	...
	editDocumentRequested(d->mIndexUnderCursor); 
}
