...
{
	QDesktopWidget DeskWidg; 
	int maxWidth = DeskWidg.availableGeometry(this).width() * 3 / 4; // KGlobalSettings::desktopGeometry(this).width() * 3 / 4;
...
void KSqueezedTextLabel::_k_copyFullText()
{
	QMimeData* data = new QMimeData;
	data->setText(d->fullText);
