...
**
****************************************************************************/
#ifndef STGRAPHICSCLIPARTITEM_H
#define STGRAPHICSCLIPARTITEM_H
...
Class to create items for clipart.
	...
	@author
*/
class STGraphicsClipartItem : public QGraphicsSvgItem, public STAbstractGraphicsItem
{
	Q_OBJECT
...
public:
	...
	//FIXME: Use UserType Que no rutlla i no se perque !!!.
	enum { Type = 1046 };
...
public:
	STGraphicsClipartItem(const QString & fileName, QGraphicsItem * parent = 0);
	STGraphicsClipartItem(QGraphicsItem * parent = 0);
