...
STCornerItem::STCornerItem(Qt::Corner corner, int _OpMask, STGraphicsItemModifier* _Modifier)
...
void STCornerItem::relayout(const QRect & rect)
{
...
QRectF STCornerItem::boundingRect() const
{
    return QRectF(-m_side, -m_side, 2*m_side, 2*m_side);
}

void STCornerItem::mouseDoubleClickEvent(QGraphicsSceneMouseEvent * event)
{
//     event->accept();
// 
//     // do the right op
...
void STCornerItem::mousePressEvent(QGraphicsSceneMouseEvent * event)
{
    event->accept();
...
void STCornerItem::mouseMoveEvent(QGraphicsSceneMouseEvent * event)
{
...
void STCornerItem::mouseReleaseEvent(QGraphicsSceneMouseEvent * event)
{
    event->accept();
...
void STCornerItem::paint(QPainter * painter, const QStyleOptionGraphicsItem * option, QWidget * /*widget*/)
{
