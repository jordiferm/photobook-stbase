...
STGraphicsMonthItem::STGraphicsMonthItem(QGraphicsItem* parent): STGraphicsTextItem(parent)
{
	init();
}


STGraphicsMonthItem::STGraphicsMonthItem(const STPhotoLayoutTemplate::Frame& _Frame, QGraphicsItem* parent): STGraphicsTextItem(_Frame, parent)
{
	init();
}

void STGraphicsMonthItem::scaleToSize(const QSizeF& _Size)
{
	scale(_Size.width() / boundingRect().width() , _Size.height() / boundingRect().height() );	
}

QString STGraphicsMonthItem::longMonthName(int _Month)
{
	QString Res; 
	switch (_Month)
	{
...
QString STGraphicsMonthItem::shortDayName(int _DayOfWeek)
{
	QString Res; 
	switch (_DayOfWeek)
	{
...
bool STGraphicsMonthItem::isHoliday(int _Day, int _Month)
{
...
QString STGraphicsMonthItem::getMonthHtml()
{
	QDate CDate; 
