...
#ifndef STGRAPHICSPHOTOITEM_H
#define STGRAPHICSPHOTOITEM_H
...
/**
	Thread for load STGraphicsPhotoItem images in background.
	@author Jordi Fernàndez <shadow@softwarelliure.com>
*/
class AlbumPhotoW;
class STGraphicsPhotoItem;
class ST_PHOTOTEMPLATES_EXPORT STGraphicsPhotoItemLoadThread : public QThread
{
Q_OBJECT
		
	QPointer<STGraphicsPhotoItem> CurrItem;
	static QMutex Mutex;
	bool Cancelled;

public:
	STGraphicsPhotoItemLoadThread(STGraphicsPhotoItem* _RelatedItem); 
	void run(); 
...
class QAction;
class ST_PHOTOTEMPLATES_EXPORT STGraphicsPhotoItem : public QObject, public QGraphicsRectItem, public STAbstractGraphicsItem
{
	Q_OBJECT 
