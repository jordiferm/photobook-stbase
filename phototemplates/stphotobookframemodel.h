...
#ifndef STPHOTOBOOKFRAMEMODEL_H
#define STPHOTOBOOKFRAMEMODEL_H
...
/**
Model for photobook frames.

@author Shadow
*/
class ST_PHOTOTEMPLATES_EXPORT STPhotoBookFrameModel : public STPhotoBookFolderDocsModel
{
Q_OBJECT
public:
	enum EnUserRoles
...
public:
	STPhotoBookFrameModel(QObject* _Parent = 0);
