...
#ifndef SPIMAGESLISTVIEW_H
#define SPIMAGESLISTVIEW_H
...
class ST_PHOTOTEMPLATES_EXPORT SPImagesListView : public SPImagesListViewBase
{
Q_OBJECT
...
public:
	SPImagesListView(QWidget* _Parent = 0);
