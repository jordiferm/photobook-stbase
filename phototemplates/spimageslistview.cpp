...
SPImagesListView::SPImagesListView(QWidget* _Parent) : SPImagesListViewBase(_Parent)
{
...
void SPImagesListView::setDiskPath(const QString& _CurrentPath)
{
	DiskAction->setChecked(true);
	setPath(_CurrentPath);
}

//void SPImagesListView::setCollectionFolderKey(quint64 _Key)
//{
...
QAction* SPImagesListView::addImageSourceAction(const QIcon& _Icon, const QString& _Text)
{
...
void SPImagesListView::selectDiskFolder()
{
...
//void SPImagesListView::selectCollectionFolder()
//{
