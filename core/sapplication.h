...
/**
Applicaci� de flam, QApplication + versi�.
Demana per a construir-se el nom de l'aplicaci� i la versi�. 
...
public:
	...
	//! Es recomana ja que mant� els settings per les diferents releases de cada minor.
