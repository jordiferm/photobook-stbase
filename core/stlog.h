...
/*! 
	Interf�cie de log. 
	Aquesta classe interpreta una s�rie de enums amb operadors de stream per a fer 
	m�s clar l'entrada d'informaci� al log. 
		
	\example 
	ISTLogIO Log;
	Log << ISTLogIO::L2 << ISTLogIO::DateTime << "Aix� �s un exemple de log" << ISTLogIO::Endl; 
	\sa STLog
...
public: 
	enum ISTLogIOLevel
	{
		...
		L2, // Log de SQl
		L3,
		L4 // M�xima informaci� de log. -> Log d'aplicaci�
	};
...
/*! 
	Classe est�tica que retorna una inst�ncia est�tica per a la generaci� de logs.
	Existeix una macro stLog. 
	
	\example 
	stLog << ISTLogIO::L2 << ISTLogIO::DateTime << "Aix� �s un exemple de log" << ISTLogIO::Endl; 
