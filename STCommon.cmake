...
IF (ST_USE_PHOTOBOOK)
		INCLUDE_DIRECTORIES( ${st-base_SOURCE_DIR}/photobook )
		INCLUDE_DIRECTORIES( ${st_photobook_BINARY_DIR} )
		SET( ST_LIBRARIES ${ST_LIBRARIES} st_photobook )
ENDIF (ST_USE_PHOTOBOOK)
...
IF (ST_USE_SINDARL)
		INCLUDE_DIRECTORIES( ${st-base_SOURCE_DIR}/sindarl )
		INCLUDE_DIRECTORIES( ${st_sindarl_BINARY_DIR} )
		SET( ST_LIBRARIES ${ST_LIBRARIES} st_sindarl )
ENDIF (ST_USE_SINDARL)

IF (ST_USE_ORDERMANAGERL)
		INCLUDE_DIRECTORIES( ${st-base_SOURCE_DIR}/ordermanagerl )
		INCLUDE_DIRECTORIES( ${st_ordermanagerl_BINARY_DIR} )
		SET( ST_LIBRARIES ${ST_LIBRARIES} st_ordermanagerl )
ENDIF (ST_USE_ORDERMANAGERL)
...
IF (ST_USE_PRNLIB)
		INCLUDE_DIRECTORIES( ${st-base_SOURCE_DIR}/prnlib )
		INCLUDE_DIRECTORIES( ${st_prnlib_BINARY_DIR} )
		SET( ST_LIBRARIES ${ST_LIBRARIES} st_prnlib )
ENDIF (ST_USE_PRNLIB)

IF (ST_USE_QJSON)
		INCLUDE_DIRECTORIES( ${st-base_SOURCE_DIR}/qjson )
		INCLUDE_DIRECTORIES( ${st-base_SOURCE_DIR}/qjson/include )
		INCLUDE_DIRECTORIES( ${qjson_BINARY_DIR} )
		SET( ST_LIBRARIES ${ST_LIBRARIES} qjson )
ENDIF (ST_USE_QJSON)
