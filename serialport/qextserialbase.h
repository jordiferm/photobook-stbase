...
typedef struct  ST_SERIALPORT_EXPORT _PortSettings {
...
class ST_SERIALPORT_EXPORT QextSerialBase:public QIODevice {
public:
    QextSerialBase();
    ...
    virtual qlonglong size() const=0;
    ...
    virtual bool waitForReadyRead(int _MSecs)=0;
