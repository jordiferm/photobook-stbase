...
/*! Retorna tot el fitxer xml en forma de QString.
	Perque funcioni aquest m�tode els settings han d'estar carregats amb el m�tode load().
	Aquesta funci� utilitzar� el fitxer de la �ltima crida amb el fitxer correcte a load()
*/
...
/*! 
	Retorna el camp que te una relaci� amb la taula _RelatedTableName
	Si no en te cap retornar� un FFieldMetaData null.
	Si la FTableMetaData �s null far� un throw.
*/
...
/*!
	En cas de no trobar _TablesMetadataDir el buscar� al $(path del binari executable)/../share/tables/
*/
